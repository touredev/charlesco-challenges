...
class Level3Test < Minitest::Test
  ...
  def test_commissions
    ...
    assert_equal rental.insurance_fee, expected_content['rentals'][0]['commission']['insurance_fee'], "Unexpected insurance fee"
    assert_equal rental.assistance_fee, expected_content['rentals'][0]['commission']['assistance_fee'], "Unexpected assistance_fee fee"
    assert_equal rental.drivy_fee, expected_content['rentals'][0]['commission']['drivy_fee'], "Unexpected Drivy fee"
  end
